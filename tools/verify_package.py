...
print(json.dumps({'version': manifest['version'], 'package_files': len(files), 'assets': len(index['assets']), 'templates': 3, 'catalog_embedded_images': 56, 'checksums': 'passed', 'source_matches_package': True}, indent=2))
